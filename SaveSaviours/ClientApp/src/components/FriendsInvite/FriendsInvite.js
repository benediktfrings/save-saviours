...
import twitterLogo from "./../../api/assets/twitter-logo.png";
  ...
  return (
    <Paper square={true} elevation={2} className={classes.registrationPaper}>
      ...
      <Grid container={true} spacing={2}>
        <Grid item={true}>
          <a
            href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Frettet-retter.de%2F&amp;src=sdkpreparse"
            target="_blank"
        ...
        <Grid item={true}>
          <a
            href="https://twitter.com/intent/tweet?text=Auf%20https%3A%2F%2Frettet-retter.de%20kann%20jeder%20schnell%20seine%20Hilfe%20in%20der%20Corona%20Krise%20anbieten%20und%20medizinischen%20Institutionen%20in%20der%20N%C3%A4he%20helfen%20-%20wenn%20Du%20helfen%20kannst%2C%20mach%20mit%21%20%23corona%20%23hilfe%20%23retter%20%23gesundheit%20%23ehrenamt%20%23gesundheitsministerium"
            target="_blank"
            rel="noopener noreferrer"
            className={classes.confirmationLink}
          >
